...
public class NBTConverter {
    ...
    private static boolean writeNativeNBT(DataOutput output, net.minecraft.server.v1_7_R1.NBTBase base) {
        try {
    ...
    private static boolean readNativeNBT(DataInput input, net.minecraft.server.v1_7_R1.NBTBase base) {
        try {
    ...
    private static net.minecraft.server.v1_7_R1.NBTBase createNativeTag(byte typeID) {
        try {
            Method method = net.minecraft.server.v1_7_R1.NBTBase.class.getDeclaredMethod("createTag", byte.class);
            method.setAccessible(true);
            net.minecraft.server.v1_7_R1.NBTBase newTag = (net.minecraft.server.v1_7_R1.NBTBase) method.invoke(null, typeID);
            return newTag;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public static net.minecraft.server.v1_7_R1.NBTBase toNative(NBTBase base) {
        // create the new NBTTag
        net.minecraft.server.v1_7_R1.NBTBase newTag = createNativeTag(base.getTypeId());
        if (newTag == null) {
            return null;
        }
    ...
    public static NBTBase fromNative(net.minecraft.server.v1_7_R1.NBTBase base) {
        // create the new NBTTag
