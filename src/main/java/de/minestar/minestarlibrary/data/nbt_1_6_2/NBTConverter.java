...
public class NBTConverter {
    ...
    private static boolean writeNativeNBT(DataOutput output, net.minecraft.server.v1_9_R2.NBTBase base) {
        try {
    ...
    private static boolean readNativeNBT(DataInput input, net.minecraft.server.v1_9_R2.NBTBase base) {
        try {
    ...
    private static net.minecraft.server.v1_9_R2.NBTBase createNativeTag(byte typeID) {
        try {
            Method method = net.minecraft.server.v1_9_R2.NBTBase.class.getDeclaredMethod("createTag", byte.class);
            method.setAccessible(true);
            net.minecraft.server.v1_9_R2.NBTBase newTag = (net.minecraft.server.v1_9_R2.NBTBase) method.invoke(null, typeID);
            return newTag;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public static net.minecraft.server.v1_9_R2.NBTBase toNative(NBTBase base) {
        // create the new NBTTag
        net.minecraft.server.v1_9_R2.NBTBase newTag = createNativeTag(base.getTypeId());
        if (newTag == null) {
            return null;
        }
    ...
    public static NBTBase fromNative(net.minecraft.server.v1_9_R2.NBTBase base) {
        // create the new NBTTag
